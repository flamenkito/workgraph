...
export default [
    {
        ignores: [
            ...
            '**/apps/api/src/test/test-context.ts',
            '**/tools/**',
            '**/jest.setup.ts',
            '**/testing/test-helpers.ts',
            '**/helpers/test-helpers.ts',
            '**/*.behaviour.ts',
            '**/tests/gateway-test-context.ts',
        ],
    },
        ...
        rules: {
            ...
            'no-restricted-syntax': [
                'error',
                {
                    ...
                    message: 'Do not use @Optional() decorator. Use explicit dependency injection instead.',
                },
                {
                    selector: 'Decorator[expression.name="Optional"]',
                    message: 'Do not use @Optional decorator. Use explicit dependency injection instead.',
                },
                {
                    selector: 'CallExpression[callee.name="forwardRef"]',
                    message: 'Do not use forwardRef(). Refactor to avoid circular dependencies.',
                },
                {
                    selector: 'Identifier[name="ModuleRef"]',
                    message: 'Do not use ModuleRef. Use explicit dependency injection instead.',
                },
                {
